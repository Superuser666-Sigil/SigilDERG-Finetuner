...
from train import ModelCardCallback, load_yaml  # noqa: E402
...
def main():
    ...
    parser.add_argument(
        "--push", action="store_true", help="Push to HuggingFace Hub (requires --repo-id)"
    )
    parser.add_argument(
        "--token",
        type=str,
    ...
    try:
        readme_content = generate_model_card_from_checkpoint(args.checkpoint_dir, args.config)
    except Exception as e:
