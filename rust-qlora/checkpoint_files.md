...
6. **`README.md`**
   - Generated by the `ModelCardCallback` / `push_model_card.py`
   - Contains full YAML metadata, training/eval details, and usage instructions
   - `update_model_card_eval.py` injects the latest metrics during evaluation workflows
